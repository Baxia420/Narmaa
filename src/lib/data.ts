...
export const airportShuttles: AirportShuttle[] = [
  ...
  },
  {
    ...
    category: "Comfort Sedan (Toyota Vios)",
    seats: 4,
    luggage: "3 medium bags",
    priceFrom: 150,
    ...
    featured: true,
    description: "Upgrade your transfer experience with a comfortable sedan for up to 4 passengers.",
  },
  {
    id: "shuttle-3",
  ...
  },
  {
    ...
    // Photo coming soon — will be updated with StarEx photo
    image: "",
    notes: ["High roof van configuration", "Spacious cabin with ample luggage capacity"],
    featured: true,
    description: "High-capacity executive van for smooth group logistics between airports and hotels. Fits up to 7 passengers comfortably.",
  },
  {
    id: "shuttle-5",
