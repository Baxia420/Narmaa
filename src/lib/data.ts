...
export const tours: Tour[] = [
  {
    ...
    priceFrom: 450,
    image: "/images/tours/malacca-tour/malacca-tour-1.webp",
    gallery: [
  ...
  },
  {
    ...
    priceFrom: 300,
    image: "/images/tours/kl-city-tour/kl-city-tour-1.webp",
    gallery: [
  ...
  },
  {
    ...
    groupType: "Private Group",
    features: ["Private Chauffeur", "Boat Rides Included", "Wildlife Experience"],
    notes: [
      "Price is per vehicle, not per person",
      "Boat tickets for eagle feeding and fireflies may be additional",
      "Seafood dinner is at your own expense",
    ],
