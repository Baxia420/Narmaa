...
export const cars: Car[] = [
  {
    ...
    gallery: [
      ...
      "/images/fleet/perodua-myvi-2.webp",
    ],
    featured: true,
    popular: true,
  ...
  },
  {
    ...
    gallery: [
      ...
      "/images/fleet/honda-city-2.webp",
    ],
    featured: true,
    ...
    description: "A reliable and spacious sedan ideal for comfortable city driving, airport pickups, and business travel. The Honda City offers great fuel economy and a smooth ride.",
  },
  {
    id: "car-3",
    slug: "toyota-innova",
    ...
    gallery: [
      "/images/fleet/toyota-innova.webp",
      "/images/fleet/toyota-innova-2.webp",
    ],
    featured: true,
    popular: true,
    ...
    description: "The Toyota Innova is a versatile 7-seater MPV perfect for families and groups. Spacious interior with ample luggage room makes it ideal for airport pickups and outstation travel.",
  },
  {
    id: "car-4",
    slug: "proton-x70",
    ...
    priceFrom: 250,
    image: "/images/fleet/proton-x70.webp",
    gallery: [
      "/images/fleet/proton-x70.webp",
      "/images/fleet/proton-x70-2.webp",
    ],
    featured: false,
    ...
    description: "A modern SUV with premium features. The Proton X70 offers a smooth ride, spacious cabin, and advanced infotainment — ideal for comfortable road trips across Malaysia.",
  },
  {
    id: "car-5",
    slug: "toyota-alphard",
    ...
    gallery: [
      ...
      "/images/fleet/toyota-alphard-2.webp",
      "/images/fleet/toyota-alphard-3.webp",
    ],
    featured: true,
    popular: true,
  ...
  },
  {
    ...
    gallery: [
      ...
      "/images/fleet/toyota-vellfire-2.webp",
    ],
    featured: false,
...
export const tours: Tour[] = [
  {
    ...
    priceFrom: 450,
    image: "/images/tours/malacca-tour.webp",
    gallery: [
      "/images/tours/malacca-tour.webp",
      "/images/tours/malacca-tour-2.webp",
    ],
    featured: true,
    location: "Malacca City",
    groupType: "Private Group",
    features: ["Private Chauffeur", "Guided City Tour", "Lunch Included", "River Cruise"],
    notes: [
      "Price is per vehicle, not per person",
      "Entrance fees and meals are not included unless stated",
  ...
  },
  {
    ...
    priceFrom: 300,
    image: "/images/tours/kl-city-tour.webp",
    gallery: [
      "/images/tours/kl-city-tour.webp",
      "/images/tours/kl-city-tour-2.webp",
    ],
    featured: true,
  ...
  },
  {
    ...
    priceFrom: 550,
    image: "/images/tours/cameron-highlands.webp",
    gallery: [
      "/images/tours/cameron-highlands.webp",
      "/images/tours/cameron-highlands-2.webp",
    ],
    featured: true,
  ...
  },
  {
    ...
    priceFrom: 300,
    image: "/images/tours/genting-highlands.webp",
    gallery: [
      "/images/tours/genting-highlands.webp",
      "/images/tours/genting-highlands-2.webp",
    ],
    featured: true,
    ...
    notes: [
      "Price is per vehicle, not per person",
      "Theme park tickets are purchased separately",
...
export const airportShuttles: AirportShuttle[] = [
  ...
  },
  {
    ...
    image: "/images/airport-shuttle/honda-city.webp",
